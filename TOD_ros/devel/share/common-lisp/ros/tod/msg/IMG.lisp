...
(cl:defclass <IMG> (roslisp-msg-protocol:ros-message)
  ((data
   ...
   (gtJson_filepath
    :reader gtJson_filepath
    :initarg :gtJson_filepath
    :type cl:string
    :initform "")
   (msglabel
    :reader msglabel
...
(cl:defmethod cl:initialize-instance :after ((m <IMG>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'IMG)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name tod-msg:<IMG> is deprecated: use tod-msg:IMG instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <IMG>))
...
(cl:ensure-generic-function 'gtJson_filepath-val :lambda-list '(m))
(cl:defmethod gtJson_filepath-val ((m <IMG>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader tod-msg:gtJson_filepath-val is deprecated.  Use tod-msg:gtJson_filepath instead.")
  (gtJson_filepath m))

(cl:ensure-generic-function 'msglabel-val :lambda-list '(m))
(cl:defmethod msglabel-val ((m <IMG>))
...
(cl:defmethod sceneid-val ((m <IMG>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <IMG>) ostream)
  ...
  (cl:let ((__ros_str_len (cl:length (cl:slot-value msg 'gtJson_filepath))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_str_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_str_len) ostream))
  (cl:map cl:nil #'(cl:lambda (c) (cl:write-byte (cl:char-code c) ostream)) (cl:slot-value msg 'gtJson_filepath))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <IMG>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:slot-value msg 'data) istream)
    (cl:let ((__ros_str_len 0))
      ...
      (cl:setf (cl:slot-value msg 'gtJson_filepath) (cl:make-string __ros_str_len))
      (cl:dotimes (__ros_str_idx __ros_str_len msg)
        (cl:setf (cl:char (cl:slot-value msg 'gtJson_filepath) __ros_str_idx) (cl:code-char (cl:read-byte istream)))))
    (cl:let ((__ros_str_len 0))
      (cl:setf (cl:ldb (cl:byte 8 0) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) __ros_str_len) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) __ros_str_len) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<IMG>)))
  ...
  "35da245cef9bef85956a419b58c6bb86")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'IMG)))
  "Returns md5sum for a message object of type 'IMG"
  "35da245cef9bef85956a419b58c6bb86")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <IMG>))
  (cl:+ 0
     ...
     4 (cl:length (cl:slot-value msg 'gtJson_filepath))
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <IMG>))
  ...
  (cl:list 'IMG
    ...
    (cl:cons ':gtJson_filepath (gtJson_filepath msg))
